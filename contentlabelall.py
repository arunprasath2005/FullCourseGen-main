...
load_dotenv()
# Prefer GOOGLE_GEMINI_KEY but also accept GOOGLE_API_KEY (some setups use this name)
...
# Use a model that's available in your account/region. Updated to a currently available model.
